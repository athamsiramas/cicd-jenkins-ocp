        ...
        stage('Rollout Service') {
            steps {
                script {
                    ...
                    def removingAppAndVersion = SERVICE_VERSION_QUERY_RESULT.split(";").find { it && !it.contains(serviceVersion) }
                    ...
                    sh "oc set route-backends ${serviceName}-route ${serviceName}-${deploymentName}-service=100 -n appuat"
